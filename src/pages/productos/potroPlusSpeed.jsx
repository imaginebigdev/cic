...
import PotroPlusSpeedDetails from "../../components/Blog-details/potroplusspeed";
...
const PotroPlusSpeed = () => {
  ...
  return (
    <LightTheme>
      ...
      <PageHeader
        title="POTRO PLUS SPEED"
        paragraph="Modelo rápido recomendado para portones de medio porte."
      />
      <PotroPlusSpeedDetails theme="light" blog={"blog"} />
      <WhatsAppButton />
      <Footer />
    </LightTheme>
  );
