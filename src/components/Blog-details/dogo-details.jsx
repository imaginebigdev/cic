                  ...
                  <div className="col-lg-10">
                    <div className="cont">
                      ...
                      <div className="spacial">
                        <p>
                          El motor Dogo 250 es un modelo recomendado para uso
                          domiciliario o para portones de bajo porte. Diseñado
                          para brindar seguridad y comodidad en la
                          automatización de portones en el hogar. Además, cuenta
                          con una instalación sencilla y un funcionamiento
                          silencioso, lo que lo convierte en una excelente
                          opción para aquellos que buscan un motor de alta
