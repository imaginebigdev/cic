      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-11">
            <div className="post">
              <div className="img">
                <img src="/img/slid/slid-potroplus.png" alt="" />
              </div>
                  ...
                  <div className="col-lg-10">
                    <div className="cont">
                      ...
                      <div className="spacial">
                        <p>
                          El motor Potro Plus es un modelo recomendado para
                          portones de medio porte. El Potro Plus es un motor
                          resistente y confiable, diseñado para brindar
                      ...
                      <div className="row">
                        <div className="col-md-6">
                          <div className="mb-10">
                            <img src="/img/productos/potro-plus.png" alt="" />
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="mb-10">
        ...
        <div className="row justify-content-center">
          <a href="/pdf/manual-potroplus.pdf" download className="btn-leermas">
...
export default PotroPlusDetails;
