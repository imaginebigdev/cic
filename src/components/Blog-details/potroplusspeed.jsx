...
const PotroPlusSpeedDetails = ({ theme }) => {
  return (
    <section className="blog-pg single section-padding pt-0">
      <div className="container">
                  ...
                  <div className="col-lg-10">
                    <div className="cont">
                      ...
                      <div className="spacial">
                        <p>
                          El motor Potro Plus Speed es un modelo recomendado
                          para portones de medio porte. El Potro Plus Speed es
                          un motor resistente, rápido y confiable, diseñado para
        ...
        <div className="row justify-content-center">
          <a
            href="/pdf/manual-potroplusspeed.pdf"
            download
            className="btn-leermas"
          >
...
export default PotroPlusSpeedDetails;
